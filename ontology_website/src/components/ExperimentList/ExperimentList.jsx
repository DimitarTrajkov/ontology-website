  ...
  useEffect(() => {
    ...
    const formatForStoring = (combination) => {
      const paramString = combination.params
        ...
        .replace(/]/g, "\\\\]");
      return encodeURIComponent(
        `${combination.datasetName}_${combination.metric}_${combination.modelName}_${paramString}`
      );
    };
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get( "http://localhost:5000/performance/metrics/Stockport%20Local%20Health%20Characteristics" );
          ...
          <FormControl className="formControll">
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                setTaskType(newDataType === "tabular" ? "regression" : "imageClassification");
              }}
              input={<Input />}
          ...
          {dataType === "images" && (
            <FormControl className="formControll">
              ...
              <Select
                ...
                MenuProps={{ disableScrollLock: true }}
              >
                <MenuItem value="imageClassification">
                  Image Classification
                </MenuItem>
                <MenuItem value="imageSegmentation">
                  Image Segmentation
                </MenuItem>
              </Select>
            </FormControl>
